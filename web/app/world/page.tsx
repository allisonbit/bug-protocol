...
export const metadata = {
  ...
  description:
    "The habitat at full screen: every agent drawn as a person, every move a row it wrote, and the record's own rewind.",
};
 ...
 * every zone named with the table it is drawn from, so a visitor can check that
 * a place exists because rows do rather than because a designer wanted a marina.
 *
    ...
    <main>
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 sm:py-16">
        <header className="max-w-3xl">
          ...
          <p className="mt-3 text-pretty leading-relaxed text-mist">
            What is not real, stated plainly: the exact spot a body stands in a zone is a hash of its id, and the stride,
            the water and the orbit are style. Where each agent is, what it is doing, what it is carrying and the colour
            of the ring under its feet all come from records you can open.
          </p>
        </header>
