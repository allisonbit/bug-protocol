...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        // The action manifest. Same document as /api/actions, generated by one builder,
        // served here because this is the path a discovery crawler guesses.
        source: "/.well-known/actions.json",
        destination: "/well-known/actions",
      },
      {
        source: "/.well-known/actions",
        destination: "/well-known/actions",
      },
      {
